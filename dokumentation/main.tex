...
\begin{center}
    \begin{tabular}{||c c c c||} 
     ...
     Bibliothek & Lizenz & Version & Website \\ [0.5ex] 
     \hline\hline
     axios & MIT License & 1.6.2 & https://axios-http.com/ \\
     [1ex]
     \hline
     pinia & MIT License & 2.0.0 & https://pinia.vuejs.org/ \\
     [1ex]
     \hline
     client-oauth2 & Apache 2.0 & 4.3.3 & https://github.com/mulesoft-labs/js-client-oauth2 \\
     [1ex]
     \hline
     apexcharts & MIT License & 3.45.0 & https://apexcharts.com/ \\
     [1ex]
     \hline
    \end{tabular}
    \end{center}
