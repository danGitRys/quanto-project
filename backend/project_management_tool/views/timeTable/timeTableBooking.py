...
class TimeTableBookingView(View):
    ...
    def post(self,request ,*args, **kwargs):
        ...
        for currentDate in dateRange.range_date(start_date,end_date):
            inProjectData = projectQuerys.timeInProjectBookedDay(project_id,employee_id,currentDate)
            outsideProjectData = projectQuerys.timeNotInProjectBookedDay(project_id,employee_id,currentDate)
